...
export default function Dropzone({ onFile, onText, loading }: DropzoneProps) {
    ...
    <div className="flex flex-col items-center justify-center h-full min-h-[60vh] px-8">
      <div className="w-full max-w-lg">
        ...
        <p className="text-gray-500 text-sm mb-6">
          SyllabAI will extract every deadline and build your plan
        </p>
        ...
        {tab === "pdf" ? (
          ...
          <>
            <textarea
              ...
              placeholder="Paste your syllabus text here. Include assignment names, due dates, and any grade weights you can find."
              rows={12}
              className="w-full rounded-2xl border border-gray-200 p-4 text-sm text-gray-700 placeholder-gray-400 resize-none focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent"
            />
            <button
              type="button"
